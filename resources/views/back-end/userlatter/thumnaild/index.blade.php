    ...
    <div class="col-sm-6 col-lg-12">
        <div class="card">
            <div class="card-header">
                <a href="{{route('thumNails.create')}}" class="btn btn-primary"> Add Data Category</a>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="display:flex ">
                                <a href="{{route('thumNails.edit',$items->id)}}" class="m-1 btn btn-info">
                                    <i class="fa fa-pencil-alt">Edit</i>
                                </a>
                                <form method="POST" class="m-1" action="{{route('thumNails.destroy', $items->id)}}">
                                    @csrf
                                    @method('delete')
